...
select descripcion,marca,min(precio) precio_minimo from articulos where descripcion ='televisores';
set sql_safe_updates=0; -- cuando no me deja oredenar o modificar activarlo. 

select descripcion,marca,precio precio_minimo from articulos 
where precio=(select min(precio)  from articulos
where descripcion = 'televisores')and descripcion = 'televisores';
...
where descripcion='aire acondicionados';
select*from articulos;
